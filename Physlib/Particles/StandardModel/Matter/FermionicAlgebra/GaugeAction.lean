...
/-- **The jet gauge action on the fermionic algebra** of a `V`-valued matter field, induced
  from a fibrewise action `rep` on the jets of the field: the exterior-algebra functor
...
noncomputable def repJetGaugeGroupI
    ...
    (hlin : ∀ (U : JetGaugeGroupI) (χ : JetRing) (z : JetRing ⊗[ℂ] V),
      rep U (χ • z) = χ • rep U z) :
    Representation ℂ JetGaugeGroupI (FermionicAlgebra V) where
  toFun U :=
    (ExteriorAlgebra.map (JetComponentSpace.repJetGaugeGroupI rep hlin U)).toLinearMap
  map_one' := by
...
lemma repJetGaugeGroupI_apply
    ...
    (hlin : ∀ (U : JetGaugeGroupI) (χ : JetRing) (z : JetRing ⊗[ℂ] V),
      rep U (χ • z) = χ • rep U z)
    (U : JetGaugeGroupI) (x : FermionicAlgebra V) :
    repJetGaugeGroupI rep hlin U x =
      ExteriorAlgebra.map (JetComponentSpace.repJetGaugeGroupI rep hlin U) x := rfl
...
lemma repJetGaugeGroupI_apply_one
    ...
    (hlin : ∀ (U : JetGaugeGroupI) (χ : JetRing) (z : JetRing ⊗[ℂ] V),
      rep U (χ • z) = χ • rep U z)
    (U : JetGaugeGroupI) :
    repJetGaugeGroupI rep hlin U (1 : FermionicAlgebra V) = 1 := by
...
lemma repJetGaugeGroupI_apply_mul
    ...
    (hlin : ∀ (U : JetGaugeGroupI) (χ : JetRing) (z : JetRing ⊗[ℂ] V),
      rep U (χ • z) = χ • rep U z)
    (U : JetGaugeGroupI) (x y : FermionicAlgebra V) :
...
lemma repJetGaugeGroupI_ι
    ...
    repJetGaugeGroupI rep hlin U (ExteriorAlgebra.ι ℂ v) =
      ExteriorAlgebra.ι ℂ (JetComponentSpace.repJetGaugeGroupI rep hlin U v) := by
...
noncomputable def repJetGaugeGroupIAlgHom
    ...
    (hlin : ∀ (U : JetGaugeGroupI) (χ : JetRing) (z : JetRing ⊗[ℂ] V),
      rep U (χ • z) = χ • rep U z)
    (U : JetGaugeGroupI) : FermionicAlgebra V →ₐ[ℂ] FermionicAlgebra V where
...
noncomputable def repGaugeGroupI
    ...
    (hlin : ∀ (U : JetGaugeGroupI) (χ : JetRing) (z : JetRing ⊗[ℂ] V),
      rep U (χ • z) = χ • rep U z) :
    Representation ℂ GaugeGroupI (FermionicAlgebra V) :=
...
lemma repGaugeGroupI_apply
    ...
    (hlin : ∀ (U : JetGaugeGroupI) (χ : JetRing) (z : JetRing ⊗[ℂ] V),
      rep U (χ • z) = χ • rep U z)
    (g : GaugeGroupI) (x : FermionicAlgebra V) :
...
lemma repGaugeGroupI_apply_one
    ...
    (hlin : ∀ (U : JetGaugeGroupI) (χ : JetRing) (z : JetRing ⊗[ℂ] V),
      rep U (χ • z) = χ • rep U z)
    (g : GaugeGroupI) :
    repGaugeGroupI rep hlin g (1 : FermionicAlgebra V) = 1 :=
...
lemma repGaugeGroupI_apply_mul
    ...
    (hlin : ∀ (U : JetGaugeGroupI) (χ : JetRing) (z : JetRing ⊗[ℂ] V),
      rep U (χ • z) = χ • rep U z)
    (g : GaugeGroupI) (x y : FermionicAlgebra V) :
